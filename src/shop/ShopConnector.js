...
import {addToCart, clearCart, updateCartQuantity, removeFromCart} from '../data/CartActionCreators';
...
const mapDispatchToProps = {
    loadData, placeOrder, addToCart, updateCartQuantity, removeFromCart, clearCart
}
// const filterProducts = (products = [], category) =>(!category || category === "All")? products: products
